...
services:
    ...
    adminer:
        ...
        labels:
            ...
            - "traefik.http.routers.adminer.rule=Host(`adminer.1596566140.localhost`)"  
    ...
    php:
        ...
        labels:
            ...
            - "traefik.http.routers.php.rule=Host(`php.1596566140.localhost`)"
